...
const teachInfo = [
  {
    id: 1,
    description: [
      `Designed and implemented curriculum that increased students academic performance and emotional wellness while equipping them with life skills.`,
      `Planned and executed a Physical Education program that was safe, inclusive, and fun, while teaching students technical and tactical skills applicable to a wide-range of games and sports.`,
      `Used the International Baccalaureate framework as a holistic model for supporting child development and fostering global citizenship.`
    ],
    qualification: 'General Studies and Physical Education Teacher',
    institution: 'The Leo Baeck Day School',
    date: '2018-2019'
  },
  {
    id: 2,
    description: [
      `Used formative assessment to document student learning and improve student outcomes through feedback and accommodations.`,
      `Engaged in professional learning based on student needs determined through careful analysis of assessment data.`,
      `Contributed to the permanence of a safe and inclusive classroom environment through continuous rapport building and the promotion of equitable practices.`
    ],
    qualification: 'Student Teaching Internship',
    institution: 'Dr. Eric Jackman Institute of Child Study',
    date: '2017-2018'
  },
  {
    id: 3,
    description: [
      `Facilitated learning opportunities that furthered students understanding of how to conduct, evaluate, interpret and reflect on research.`,
      `Designed lessons that make use of various approaches to learning and created tasks that offered a high-degree of choice and natural differentiation.`,
      `Supported student attainment of global competencies through projects that necessitated problem solving, collaboration, and innovation.`
    ],
    qualification: 'Student Teaching Practicums',
    institution: `Various TDSB Schools`,
    date: '2016-2017'
  }
];
...
const eduInfo = [
  ...
  },
  {
    ...
    qualification:
      'Honours Bachelor of Arts in Psychology with Research Specialist Distinction',
  ...
  },
  {
    id: 3,
    description: [
      `Explored the nature of numerous micro and macro economic markets.`,
      `Gained an understanding of how demographics and environmental issues shape business decisions.`
    ],
    qualification: 'Minor in Economic Studies',
    institution: 'Wilfrid Laurier University, Waterloo, ON',
    date: '2012-2016'
  }
];

export { compInfo, teachInfo, eduInfo };
